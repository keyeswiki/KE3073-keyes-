...
![](./media/f27a7b70eae604dfb10cfed819daae0e.png)
...
![](./media/f09ae54b6b88847dd7d4eaa5da0ac0b9.png)

5. 项目现象： 

按照接线图正确接好各元器件，选择正确的主板类型Arduino Uno和COM端口，点击Mixly IDE上的上传按钮![](./media/b4f4acae3120d304c02aab38f4cff370.png)上传代码。上传成功后，利用MicroUSB线连接到计算机上电，单击![](./media/76c0e9eefc20f81b3990e5b8e2081193.png)图标进入串行监视器，设置波特率为 **9600** ，这样串口监视器不断地打印“Hello World!”。

![](./media/fbbec52aeb09086200c9d90c9c10eae9.png)

6. 代码说明

![](./media/e20ed4dd6d9ce0a7283fdae7e70aca44.png)

设置波特率为9600。

![](./media/036b41281530d43be9f137cc797a231b.png) 

换行输出数据。从串行端口输出数据，跟随一个回车和一个换行符。 

![](./media/f1c4bd20bb77da375c3d9728522f0f63.png)

将程序的执行暂停一段时间，也就是延时，单位是秒。 

![](./media/60ddb8cf11cc13991d5a56c4f6924c91.png)
...
![](./media/fe6960fc55f8a8156162f80f16f353ef.png)

6. 项目现象：

按照接线图正确接好各元器件，选择正确的主板类型Arduino Uno和COM端口，点击Mixly IDE上的上传按钮![](./media/b4f4acae3120d304c02aab38f4cff370.png)上传代码。项目代码上传成功后，利用MicroUSB线连接到计算机上电，可以看到的现象是：LED被点亮。

![](./media/96672306fbbac2d8b33a55315d0d8fc5.png)

7. 代码说明:

![](./media/8296c8457d6f4d3ac24c3dd077ee3aca.png) 
...
![](./media/b62638850a32e4f951ca78c4973b36b3.png)

5. 项目现象：

按照接线图正确接好各元器件，选择正确的主板类型Arduino Uno和COM端口，点击Mixly IDE上的上传按钮![](./media/b4f4acae3120d304c02aab38f4cff370.png)上传代码。项目代码上传成功后，利用MicroUSB线连接到计算机上电，可以看到的现象是：电路中的LED会反复闪烁。
...
![](./media/9ac97a21ad1ddf7c763f5c1a16bd92b8.png)

5. 项目现象：

按照接线图正确接好各元器件，选择正确的主板类型Arduino Uno和COM端口，点击Mixly IDE上的上传按钮![](./media/b4f4acae3120d304c02aab38f4cff370.png)上传代码。项目代码上传成功后，利用MicroUSB线连接到计算机上电，你会看到的现象是：1.首先，绿灯会亮5秒，然后熄灭；2.其次，黄灯会闪烁3次，然后熄灭；3.然后，红灯会亮5秒，然后熄灭；4.继续运行上述1-3个步骤。
...
![](./media/f1769070bf37b11526e0638533064586.png)
...
![](./media/e44041765a6e1c42c3eabec588c8141a.png)

6. 项目现象：

按照接线图正确接好各元器件，选择正确的主板类型Arduino Uno和COM端口，点击Mixly IDE上的上传按钮![](./media/b4f4acae3120d304c02aab38f4cff370.png)上传代码。项目代码上传成功后，利用MicroUSB线连接到计算机上电，可以看到的现象是：电路中的LED从暗逐渐变亮，再从亮逐渐变暗，就像呼吸一样。

![](./media/7a0d2717b48056cbef36f880212d8e07.png)

7. 代码说明:

![](./media/252517ffa8952e462f75873f5fd77cd6.png) 

将数字引脚3的PWM值设置为0，是LED熄灭。

![](./media/b51ba516fa6336149fa3015d569a0026.png) 

将数字引脚3的PWM值设置为i。

![](./media/2ff979682271935974e632a34f6b196f.png)

设置一个变量i，i从0逐渐增加到255，每一次都加1，总共加了255次， 每次以10毫秒的频率增加1，LED逐渐变亮。

![](./media/49621a8692fde1154afcf0f361794bca.png)
...
![](./media/2e09f32fdd9c445739396021015fc904.png)

5. 项目现象：

按照接线图正确接好各元器件，选择正确的主板类型Arduino Uno和COM端口，点击Mixly IDE上的上传按钮![](./media/b4f4acae3120d304c02aab38f4cff370.png)上传代码。项目代码上传成功后，利用MicroUSB线连接到计算机上电，可以看到的现象是：电路中的5个LED会逐渐亮起来，然后逐渐熄灭，就像电池充电一样。
...
![](./media/2ddf8079ac8328153df249a3a35ad0bc.png)

设置引脚D2-D6上的电平为低，5个LED均不亮。

![](./media/37901a118140c4f8e2c2841093f60515.png)

设置一个引脚变量i，i从2逐渐增加到6，设置引脚i为高电平，以100毫秒的频率逐渐点亮引脚D2-D6上的LED灯。

![](./media/b41db0bf864d685a8f02f525e488a062.png)
...
![](./media/69847bea54a86d9107f4798293cdcd60.png)

6. 项目现象：

按照接线图正确接好模块，选择正确的主板类型Arduino Uno和COM端口，点击Mixly IDE上的上传按钮![](./media/b4f4acae3120d304c02aab38f4cff370.png)上传代码。项目代码上传成功后，利用MicroUSB线连接到计算机上电，可以看到的现象是：有源蜂鸣器发出“滴滴”声。
...
![](./media/6717e9c0732f92896d4cbebd2d613880.png)

6. 项目现象：

按照接线图正确接好模块和各元器件，选择正确的主板类型Arduino Uno和COM端口，点击Mixly IDE上的上传按钮![](./media/b4f4acae3120d304c02aab38f4cff370.png)上传代码。项目代码上传成功后，利用MicroUSB线连接到计算机上电，你会看到的现象是：继电器将循环开与关，开启1秒LED点亮1秒，关闭1秒LED熄灭1秒。同时可以听到继电器开与关的声音，还可以看到继电器上的指示灯指示状态的变化。
...
![](./media/93cb190cc0bb50669600056f581665a2.png)

6. 项目现象：

按照接线图正确接好模块，选择正确的主板类型Arduino Uno和COM端口，点击Mixly IDE上的上传按钮![](./media/b4f4acae3120d304c02aab38f4cff370.png)上传代码。项目代码上传成功后，利用MicroUSB线连接到计算机上电，点击![](./media/76c0e9eefc20f81b3990e5b8e2081193.png)打开串口监视器，设置波特率为 **9600**，你会看到的现象是：当电容触摸传感器模块上的感应区感应到触摸时，板载红色LED灯点亮，value 值为 1，串口监视器打印出“**1  Touch the button**”；当没有感应到触摸时，板载红色LED灯熄灭，value 值为 0，串口监视器打印出“**0  Loosen the button**”。

![](./media/1621ead35e137435b35b3a2dd2b852b9.jpg)

![](./media/fd1a8ec9d51f53ef992aa3c320136bdb.png)

7. 代码说明:

![](./media/2ea750fba2c401a6dd6160d343eb7d90.png) 

如果![](./media/1bf2ed2d69eb91b909f6bacfe1b2d558.png)里的表达式为真，则执行![](./media/1c19cfd62757bb230a5dec02e00a2788.png)块内的代码。如果![](./media/1bf2ed2d69eb91b909f6bacfe1b2d558.png)里表达式为假 ，则执行![](./media/80f64cfe38a29760e18f858c59b43175.png)块内的代码。 

![](./media/5258b14aa0abbdf5880a781420612285.png)   

读取电容触摸传感器的数字电平，高(HIGH)或者低(LOW)。如果该引脚未连接任何东西，则![](./media/5258b14aa0abbdf5880a781420612285.png) 可以返回“高”或“低”（并且可以随机更改）。 

![](./media/e20ed4dd6d9ce0a7283fdae7e70aca44.png) 

初始化串口通信，并设置波特率为9600。  

![](./media/dab702048db1380edee6bbee885aec27.png)  

未换行输出数据。从串行端口输出数据，跟随一个回车和一个未换行符。

![](./media/7f2b7cc4a374b40125cd4deff5e250cf.png) 

换行输出数据。从串行端口输出数据，跟随一个回车和一个换行符。 

![](./media/f4dcf76ab617deb6a17553a26a853acc.png) 

这是创建“<span style="color: rgb(255, 76, 65);">变量</span>”的指令方块，可以声明“全局”或“局部”，还可以设置变量的类型、名称和赋值，val是变量名称。

![](./media/5e706016cf5fa4aab7782297bc5b328c.png) 

获取变量val。

![](./media/08c92d73efcf0333c1df21f84304127c.png)

设置变量val的值。

![](./media/2d792279f01fd1f164a39dfe3c7b09f2.png)

电容触摸传感器读取数字电平信号输出，并串口不换行打印。

![](./media/245f48851443a2591c47619a67c700fd.png)
...
![](./media/44a8baa93fc21042b27113d8c8fa3593.png)

5. 项目现象：

按照接线图正确接好模块和各元器件，选择正确的主板类型Arduino Uno和COM端口，点击Mixly IDE上的上传按钮![](./media/b4f4acae3120d304c02aab38f4cff370.png)上传代码。项目代码上传成功后，利用MicroUSB线连接到计算机上电，你会看到的现象是：当用手指触摸电容触摸传感器模块上的感应区时，模块上的板载红色LED灯点亮，外接LED灯快速闪烁。

![](./media/a46c25a9eb8bec8aec8d68fc03ddbe31.jpg)

6. 代码说明:

![](./media/5550f2836a7f78b2be20712f3cd88ab8.png)
...
![](./media/7213b7769a5c78536037b1ce6f60923c.png) 
...
![](./media/c99a181c7d68556b269b14c6ebad6eb7.png)

5. 项目现象：

按照接线图正确接好模块和各元器件，选择正确的主板类型Arduino Uno和COM端口，点击Mixly IDE上的上传按钮![](./media/b4f4acae3120d304c02aab38f4cff370.png)上传代码。项目代码上传成功后，利用MicroUSB线连接到计算机上电，你会看到的现象是：用手指触摸电容触摸传感器模块上的感应区时，模块上的板载红色LED灯点亮，有源蜂鸣器发出警报，外接LED灯快速闪烁。
